        ...
        <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4 overflow-hidden relative">
            ...
            <div className="z-10 text-center max-w-5xl w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                    {/* Module 1 */}
                    <Link href={results.m1 ? "/second-genesis/module1/result" : "/second-genesis/module1"} className="group relative">
                    ...
                    {/* Module 2 */}
                    <Link href={results.m2 ? "/second-genesis/module2/result" : "/second-genesis/module2"} className="group relative">
                    ...
                    {/* Module 3 */}
                    <Link href={results.m3 ? "/second-genesis/assessment/result" : "/second-genesis/assessment"} className="group relative">
                ...
                {/* Additional Link Box */}
                <Link href="/second-genesis/guide" className="group relative">
                ...
                <div className="mt-8">
                    {(results.m1 && results.m2 && results.m3) ? (
                        <Link href="/second-genesis/report" className="px-12 py-4 rounded-full font-bold text-lg tracking-widest transition-all duration-300 flex items-center gap-4 mx-auto bg-white text-black hover:bg-gray-200 shadow-[0_0_20px_rgba(255,255,255,0.3)] w-fit">
