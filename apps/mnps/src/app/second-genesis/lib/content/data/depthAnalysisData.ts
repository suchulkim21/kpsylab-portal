export function getIdentityConflictAnalysis(shadowTerm: string, idealTerm: string): string {
...
export function getBehavioralMaskAnalysis(maskTerm: string): string {
    // 1. Phenomenological description
...
export function getStrategicFailureAnalysis(gapDim: string, gapDimTerm: string, calibration: string): string {
    // 1. Phenomenological description
